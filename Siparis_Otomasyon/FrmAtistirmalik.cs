...
{
    public partial class FrmAtistirmalik : Form
    {
        public FrmAtistirmalik()
        {
            InitializeComponent();
        }
        ...
        //    dataGridViewMagaza.DataSource = daset.Tables["Urun"];
        //    bgl.baglanti().Close();
        //}
        

        private void FrmMagazaUrun_Load(object sender, EventArgs e)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter adtr=new SqlDataAdapter("Select * From urun where kategori = 'Gıda'", bgl.baglanti());
            adtr.Fill(dt);
            dataGridViewAtistirmalik.DataSource = dt;
        ...
        private void dataGridViewAtistirmalik_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            int secilen = dataGridViewAtistirmalik.SelectedCells[0].RowIndex;
            cmbkategori.Text = dataGridViewAtistirmalik.Rows[secilen].Cells[1].Value.ToString();
            cmbmarka.Text = dataGridViewAtistirmalik.Rows[secilen].Cells[2].Value.ToString();
            txtıd.Text = dataGridViewAtistirmalik.Rows[secilen].Cells[0].Value.ToString();
            txturunadi.Text = dataGridViewAtistirmalik.Rows[secilen].Cells[6].Value.ToString();
            txtmiktari.Text = dataGridViewAtistirmalik.Rows[secilen].Cells[3].Value.ToString();
            txtfiyat.Text = dataGridViewAtistirmalik.Rows[secilen].Cells[4].Value.ToString();
            txtKDV.Text = dataGridViewAtistirmalik.Rows[secilen].Cells[5].Value.ToString();
            txtaciklama.Text = dataGridViewAtistirmalik.Rows[secilen].Cells[8].Value.ToString();
            txttoplamfiyat.Text = dataGridViewAtistirmalik.Rows[secilen].Cells[9].Value.ToString();
            txtmiktari.Text = "1";
        }
